...
| 触发                                                                                           | 技能                        |
| ---------------------------------------------------------------------------------------------- | --------------------------- |
| "实现" / "写代码" / "改代码" / "落地" / "按方案" / `$implement` / think 出方案后落实成代码改动 | `skills/implement/SKILL.md` |

### 3. 验证阶段

| 触发                                                                                               | 技能                   |
| -------------------------------------------------------------------------------------------------- | ---------------------- |
| "测试" / "跑测试" / "加测试" / "单元测试" / "回归" / "验证" / `$test` / 实施后补回归覆盖或执行测试 | `skills/test/SKILL.md` |

### 4. 把关阶段

| 触发                                                                                                  | 技能                     |
| ----------------------------------------------------------------------------------------------------- | ------------------------ |
| "review" / "评审" / "把关" / "看看变更" / "合并前检查" / `$review` / 实施 / 测试完成,合并前的质量审查 | `skills/review/SKILL.md` |
