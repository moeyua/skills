...
Docs does not edit implementation or perform git/GitHub delivery. Report the changed targets and established truth concisely, identifying authority or omissions when they affect trust in the result. A standalone Docs ends there; when composed inside an authorized outcome, return the result to its caller for continued work.
