---
name: moeyua
description: Moeyua's opinionated tooling and conventions for JavaScript/TypeScript projects. Use when setting up new projects, configuring ESLint/Prettier alternatives, monorepos, library publishing, or when the user mentions Moeyua's preferences.
metadata:
  author: Moeyua
  version: "2026.03.18"
---
...
| App Development | Vue/Nuxt/Tailwind conventions and patterns | [app-development](references/app-development.md) |
