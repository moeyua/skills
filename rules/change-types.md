...
- plan selects exactly one type for each work item: local plans use it for plan structure, and GitHub Issues use it for their single label and semantic schema;
